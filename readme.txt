...
Tags: cbnet, twitter, twitter list, twitter lists, twitter tools, widget
Requires at least: 2.9
Tested up to: 3.0.3
Stable tag: 1.0

Do not use this Plugin. It is obsolete and no longer supported. Use the cbnet Twitter Widget Plugin instead.
...
**This Plugin is obsolete, and no longer maintained. It has been merged with the <a href="http://wordpress.org/extend/plugins/cbnet-twitter-widget">cbnet Twitter Widget</a> Plugin. Please <a href="">install the cbnet Twitter Widget Plugin now</a> in order to continue to receive updates and support.**
...
3. Find the widget titled 'cbnet Twitter List Display'
...
* **Twitter User ID**: User Id for the Twitter user list you wish to display. (Note: you can use *any* Twitter list, not just your own)
* **Twitter List**: Name of the Twitter List you wish to display (Note: case insensitive)
* **List Title**: Title that will appear at the top of the the displayed widget
* **Caption**: A short description of the Twitter list
...
= 1.0 =
* Plugin Obsoleted. Please <a href="">install the cbnet Twitter Widget Plugin now</a> in order to continue to receive updates and support.

= 0.3.1 =
* Updated readme file (Donate Link)

= 0.3 =
* Updated readme file (plugin/author URIs)

= 0.2 =
* Added support for auto-width option
* Fixed checkbox setting bug
* Corrected typos in readme file

= 0.1 =
* Initial Release
* All configurable settings are available, *except* for Auto-Width
...
= 0.3.1 =
Version 0.3.1 updates the readme file.

= 0.3 =
Version 0.3 updates the readme file.

= 0.2 =
Version 0.2 adds support for the auto-width option and fixes a checkbox setting bug.
